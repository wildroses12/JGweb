...
function showCollapsibleBox(){
    ...
    if(!shown){
        ...
        if (window.location.pathname === "/rodjendani/index.html") {
        ...
        if (window.location.pathname === "/mature/index.html") {
            collapsibleBoxElement.innerHTML = `<div class="event-type-box">
        <div>
            <a href="../krstenja/index.html">KRŠTENJA</a>
        </div>
        ...
        if(window.location.pathname === "/krstenja/index.html"){
            collapsibleBoxElement.innerHTML = `<div class="event-type-box">
            <div>
                <a href="../mature/index.html">MATURE</a>
            </div>
        ...
        if(window.location.pathname === "/index.html" || window.location.pathname === "/o-meni/index.html" || window.location.pathname === "/cenovnik/index.html"){
            collapsibleBoxElement.innerHTML = `<div class="event-type-box">
            <div>
